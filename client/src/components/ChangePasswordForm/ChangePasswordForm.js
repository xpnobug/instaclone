...
const ChangePasswordForm = ({ currentUser, token, showAlert }) => {
  ...
  return (
    <SettingsForm onSubmit={(event) => handleSubmit(event)}>
      ...
      <SettingsFormGroup>
        <label className="heading-3 font-bold">旧密码</label>
        <FormInput
      ...
      <SettingsFormGroup>
        <label className="heading-3 font-bold">新密码</label>
        <FormInput
      ...
      <SettingsFormGroup>
        <label className="heading-3 font-bold">确定新密码</label>
        <FormInput
